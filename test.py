...
def check_hinge_loss_single():
    ...
    feature_vector = np.array([8.34650603, 3.93517277, 8.92227436, 3.64693093, 6.98673019, 5.86939035
, 8.18180887, 5.7362267 , 4.6175008, 7.20642107])
    label, theta, theta_0 = -1, np.array([7.74027931, 1.4496546, 7.59119544, 4.0577159,  5.56057722, 6.7634373
, 3.59983137, 1.19460405, 7.8793072, 1.74340726]), 1
    exp_res = 1 - 0.8
    if check_real(
...
def check_hinge_loss_single_bk():
    ex_name = "Hinge loss single"
